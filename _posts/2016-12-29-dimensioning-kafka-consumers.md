 ...
 * producer speed (messages/sec) - sum of speed of all producers producing messages to the given Kafka topic. This is the average speed. You have to calculate it for yourself.
